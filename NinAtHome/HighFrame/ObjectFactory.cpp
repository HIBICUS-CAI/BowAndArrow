    ...
    SceneManager* _smPtr)
{
    ...
    RegisterTempBtnCmd(this);
    RegisterTitleButton(this);
    RegisterModeSelectButton(this);
    RegisterBowLoadingFade(this);
    RegisterBowAction(this);
    RegisterArrowAction(this);
    RegisterAimPointAction(this);
    RegisterSunsManager(this);
    RegisterFieldAction(this);
    RegisterCloudAction(this);
    RegisterResultLoadingFade(this);
    RegisterResultInput(this);
    RegisterExtraLoadingFade(this);
    RegisterExtraPlayerInput(this);
    RegisterExtraSunsManager(this);
    RegisterExtraLife(this);
    RegisterExtraGodsManager(this);
    RegisterManualAction(this);
    RegisterStoryAction(this);
